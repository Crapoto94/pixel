...
export const GAGES = [
  ...
  { id: 'glitch-tax', titre: 'GLITCH TAX', desc: 'Le Glitch a frappé : toute la table fait un “cheers” (gorgée ou soft, au choix de chacun).', alt: '—', intensity: 1, pool: ['collectif', 'sabotage'] },
];
