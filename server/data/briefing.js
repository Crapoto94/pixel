...
export const SCENARIO_SLIDES = [
  ...
  { title: '⏱️ EN PARALLÈLE',
    text: "Entre les énigmes et les mini-jeux, gardez l'œil ouvert : faites vos défis photo, consultez votre CARNET SECRET (mission + indice perso), surveillez le GLITCH… et gardez vos VIES ❤️. Tout compte pour le HIGH SCORE final !" },
  { title: '📱 PLEIN ÉCRAN',
