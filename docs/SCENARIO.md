# 🕹️ PIXEL PANIC
### *Le jour où Vincent a buggé la réalité*

> Bible du jeu — soirée d'anniversaire de Vincent
> 7 joueurs (Vincent + 6 invités) · durée 4 à 5 h · univers rétro-arcade 8-bit · gages bien arrosés

---

## 1. Le pitch (ce que vivent les joueurs)

Pendant l'apéro, la **tablette-borne d'arcade** (« la BORNE ») se met à grésiller toute seule et affiche un message d'alerte : une vieille borne d'arcade maudite, *PIXEL PANIC*, vient de **fusionner avec la réalité**. Le « monde réel » est maintenant un jeu vidéo qui plante.
...
## 2. Les rôles (distribués via QR + SMS perso)

> Chaque joueur scanne un QR code à l'entrée → arrive sur **sa** page perso (`https://pixel.fbc.fr/j/<token>`). Personne ne voit l'écran des autres. La page se met à jour seule au fil des mondes.
...
**Enfants (sans smartphone) — PNJ :**

| Enfants | Rôle | Mission |
|---------|------|---------|
...
## 3. Les ingrédients physiques (distribués au fur et à mesure)

Pour que **rien ne soit cousu de fil blanc**, le matériel n'arrive jamais d'un coup. **Pas de cadenas physique** : on utilise un **« cadenas numérique »**. Le code trouvé à la fin d'un MONDE se tape **dans l'appli** (page joueur ou BORNE). S'il est bon, la BORNE affiche *« PIXELS, livrez le COLIS N°X »* → **Robin & Juliette** (les enfants-PNJ) vont chercher l'**enveloppe/pochette opaque** numérotée correspondante et la remettent à la table. Mystère préservé, zéro quincaillerie, et les enfants ont un vrai rôle.

**Kit à préparer (détaillé dans `docs/MATERIEL.md`) — que des fournitures de bureau :**

- 🎟️ 6 cartes-avatars (papier plastifié ou pochette) + 1 carte dorée « PLAYER ONE » dans une enveloppe scellée
- ✉️ **6 enveloppes/pochettes opaques numérotées « COLIS 1 → 6 »** (kraft, ou enveloppes A5) — une par MONDE, simplement scellées (autocollant). Pas de cadenas.
- 🪙 Des « PIÈCES » (jetons / chocolats dorés / pièces en carton) distribuées comme récompenses
- ❤️ 3 « VIES » physiques (ex : 3 bracelets / 3 cartes cœur) — quand un joueur rate, il en perd une
- 🧩 Pièces de puzzle, cartes à indices, un QR caché ; **option facile** : un stylo à encre invisible UV (~5 €) pour les indices secrets de LARA CROÛTE
- 🥤 Quelques boissons (avec et **sans** alcool) — les gages restent **légers** : au pire une gorgée, toujours une alternative défi
- 📺 La **BORNE** (tablette) sur pied/support, branchée, volume à fond — c'est l'écran de jeu partagé

---

## 4. Déroulé minute par minute (~4 h 30)

> Format de chaque MONDE : **Intro vidéo borne → énigme (ingrédients) → code → déverrouillage boîte suivante → BONUS STAGE (gage arrosé) → rebondissement**. Compte ~35–45 min par monde.
...
### ⏱️ 2:30 — 🎂 PAUSE GÂTEAU / RAVITAILLEMENT (~20 min)
...
## 5. Catalogue de gages & défis (légers, alcool optionnel)

> **Règle d'or : jamais de cul-sec.** Au pire une **gorgée**, et **toujours une alternative défi/fun** sans alcool. Le fun vient du défi et de l'humour, pas de la cuite. Le serveur tire au sort dans des « pools » selon le contexte. Exemples :
...
## 5bis. La BORNE comme écran de jeu PARTAGÉ (les téléphones = manettes)

> La tablette n'est **pas** un simple panneau d'affichage : c'est une **console partagée interactive**. Tout le monde regarde le même grand écran, et **les smartphones deviennent les manettes / buzzers** synchronisés en temps réel. C'est le cœur des moments collectifs.

**🟢 Jeux COLLECTIFS (tout le monde joue, tout le monde regarde la BORNE)**
...
## 7. Ce que je construis côté technique (aperçu)

- **`pixel.fbc.fr`** — appli Node.js (LXC sur ton Proxmox).
  - **Page joueur mobile** (`/j/<token>`) : avatar, missions perso, énigmes, votes, gages, auto-refresh.
...
*Prochaine étape : tu valides/ajustes ce scénario, puis je commence à coder l'appli et à générer le matériel.*
